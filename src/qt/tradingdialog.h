...
private slots:
    ...
    void on_BuyEurope_clicked();
    void on_SellEuropeBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputEurope_textChanged(const QString &arg1);
    ...
    QString BuyEurope(QString OrderType, double Quantity, double Rate);
    QString SellEurope(QString OrderType, double Quantity, double Rate);
