...
unsigned int nTargetSpacing = 1 * 30; // Europe - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // Europe - time to elapse before new modifier is computed
...
const string strMessageMagic = "Europe Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Europe", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-europe-40322140";
        CTransaction txNew;
        txNew.nTime = 1497812250;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("a0cef4dca3bc422c919cb2472ebabcfd2dee62b66ed9d005bc0365d2f3f51283"));
