...
!define URL http://www.Europe.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Europe.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Europe-qt.exe
...
OutFile Europe-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Europe-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Europed.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Europe.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Europe-qt.exe
